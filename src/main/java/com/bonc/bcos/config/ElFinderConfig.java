...
import com.bonc.bcos.elfinder.command.CommandFactory;
import com.bonc.bcos.elfinder.core.Volume;
import com.bonc.bcos.elfinder.core.VolumeSecurity;
import com.bonc.bcos.elfinder.core.impl.DefaultVolumeSecurity;
import com.bonc.bcos.elfinder.core.impl.SecurityConstraint;
import com.bonc.bcos.elfinder.param.Node;
import com.bonc.bcos.elfinder.service.ElfinderStorage;
import com.bonc.bcos.elfinder.service.ElfinderStorageFactory;
import com.bonc.bcos.elfinder.service.VolumeSources;
import com.bonc.bcos.elfinder.service.impl.DefaultElfinderStorage;
import com.bonc.bcos.elfinder.service.impl.DefaultElfinderStorageFactory;
import com.bonc.bcos.elfinder.service.impl.DefaultThumbnailWidth;
import com.bonc.bcos.elfinder.support.locale.LocaleUtils;
...
public class ElFinderConfig {
    ...
    private final ElfinderConfiguration elfinderConfiguration;

    @Autowired
    public ElFinderConfig(ElfinderConfiguration elfinderConfiguration) {
        this.elfinderConfiguration = elfinderConfiguration;
        elfinderConfiguration.initVolumes();
    }

    @Bean(name = "commandFactory")
    public CommandFactory getCommandFactory() {
        CommandFactory commandFactory = new CommandFactory();
        commandFactory.setClassNamePattern("com.bonc.bcos.elfinder.command.%sCommand");
