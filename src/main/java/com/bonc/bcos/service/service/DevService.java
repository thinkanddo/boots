...
public interface DevService {
     ...
     * @return 设备列表
     */
    List<SysClusterHostRoleDev> findDev(String code,String ip,String roleCode);
     ...
     * 1.检查节点ip是否存在
     * 2.检查节点ip对应的状态是否需要更新
     *  0 未使用     1 已禁用     2 已使用     3 禁止格式化
     *
     * 主机设备状态更新接口(default角色对应的设备),是否启用主机的设备可以被使用
     * @param changeDev 对象 设备
     *
     * 已经
     */
    void changeDevStatus(SysClusterHostRoleDev changeDev) ;
     ...
     * @param targets 目标主机
     */
    void allocate(Set<String> targets,String code) ;

    List<SysClusterStoreCfg> getStoreCfg (String roleCode);

    SysClusterHostRoleDev saveDev(String code, SysClusterHostRoleDev dev);

    boolean delDev(String code, SysClusterHostRoleDev dev);
}
