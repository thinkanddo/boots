...
public interface ExecService {
	 ...
	 * @return data:{uuid：""}
	 */
	ExecProcess exec(List<String> targets, String playCode,String code) ;
	 ...
	 */
	void resume(String uuid,String code) ;

	void pause(String uuid,String code);

	void stop(String uuid, String code);
	 ...
	 * }
	 */
	ExecProcess query(String uuid,String code) ;
	 ...
	 * @return 任务ID
	 */
	ExecProcess getLatestTask(String playCode,String code);

	void reset();

    List<SysInstallPlay> findPlays();

    List<SysInstallPlayExec> findLogs(String code);

	Object downLog(HttpServletResponse res, String uuid,String code) throws IOException;

	Boolean deleteTask (String uuid);

	SysInstallPlayExec editTask(SysInstallPlayExec exec, String code);
}
